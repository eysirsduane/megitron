...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    ...
    meta: {
      constant: true,
      title: 'transaction',
      i18nKey: 'route.transaction',
      order: 1
    },
    children: [
      {
        name: 'transaction_delegate',
        path: '/transaction/delegate',
        component: 'view.transaction_delegate',
        meta: {
          constant: true,
          title: 'transaction_delegate',
          i18nKey: 'route.transaction_delegate',
          icon: 'icon-park-outline:editor'
        }
      },
      {
        ...
        component: 'view.transaction_exchange',
        meta: {
          title: 'transaction_exchange',
          i18nKey: 'route.transaction_exchange',
          icon: 'carbon:network-overlay'
        }
      }
    ]
